						...
						<el-col :span="12">
							<div class="pay saleBgcolor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ YearProfitLoss }}<span class="perTitle">({{ $t('index.tenMillion') }})</span></p>
								</div>
								<div class="rightItem">
						...
						<el-col :span="12">
							<div class="pay taxBgcolor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ YearProfitRatio }}<span class="perTitle">(%)</span></p>
								</div>
								<div class="rightItem">
						...
						<el-col :span="6">
							<div class="extenedBgcolor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ PotentialInvestor }}<span class="perTitle">({{ $t('index.person') }})</span></p>
						...
						<el-col :span="6">
							<div class="likeBgcolor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ ProspectiveInvestor }}<span class="perTitle">({{ $t('index.person') }})</span></p>
						...
						<el-col :span="6">
							<div class="linkBgColor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ PendingInvestor }}<span class="perTitle">({{ $t('index.person') }})</span></p>
						...
						<el-col :span="6">
							<div class="keleBgColor data_list rflex">
								<div class="leftItem cflex wflex">
									...
									<p class="number">{{ InvestorUnderReview }}<span class="perTitle">({{ $t('index.person') }})</span></p>
...
<script>
	...
	export default {
		data(){
			return {
				github: github,
				YearProfitLoss: 78,//年盈亏
				YearProfitRatio: 138,//年利率
				PotentialInvestor: 8013,//潜在投资人
				ProspectiveInvestor: 11001,//意向投资人
				PendingInvestor: 120101,//待审投资人
				InvestorUnderReview: 813101,//审核中投资人
			}
		},
		components: {
			salesTable,
